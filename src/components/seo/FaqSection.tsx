          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 transition-all duration-200 ${
                      isOpen ? "rotate-180 bg-amber-100 text-amber-900" : "bg-slate-100 text-slate-500 group-hover:bg-amber-100 group-hover:text-amber-900"
                    }`}
                  >
                ...
                {isOpen && (
                  <div className="mt-4 pt-3.5 border-t border-slate-100 text-slate-600 text-xs sm:text-sm font-medium leading-relaxed pl-10 animate-in fade-in duration-200">
                    {faq.answer}
                  </div>
                )}
              </div>
